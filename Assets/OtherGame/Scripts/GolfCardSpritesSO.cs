...
[CreateAssetMenu(fileName = "CardSprites", menuName = "ScriptableObjects/CardSpritesSOGolf")] // a
public class GolfCardSpritesSO : ScriptableObject
{
    [Header("Card Stock")]
    ...
    private static GolfCardSpritesSO S;
    ...
    static void INIT_STATICS(GolfCardSpritesSO cSSO)
    {
        if (S != null)
        {
